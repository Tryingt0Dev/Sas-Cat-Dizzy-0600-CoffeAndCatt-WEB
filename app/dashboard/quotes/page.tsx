    ...
    <div>
      ...
      <div className="grid gap-6 xl:grid-cols-[430px_1fr]">
        <Card>
          ...
          <form action={createQuoteAction} className="mt-5 space-y-3">
            ...
            <div className="space-y-2">
              {[0, 1, 2, 3, 4].map((index) => (
                <div key={index} className="grid grid-cols-[1fr_90px] gap-2">
                  ...
                  <Input name="quantity" type="number" min={0} defaultValue={index === 0 ? 1 : 0} />
                </div>
              ))}
            </div>
        ...
        <div className="space-y-4">
          ...
          {quotes.length === 0 && <Card><p className="text-gray-500">Aún no hay cotizaciones.</p></Card>}
        </div>
      </div>
    </div>
  );
