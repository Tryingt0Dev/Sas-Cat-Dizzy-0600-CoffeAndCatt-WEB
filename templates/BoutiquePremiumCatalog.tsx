  ...
  return (
    <main className="min-h-screen bg-[var(--catalog-bg)]" style={themeStyle}>
      <section className="mx-auto grid max-w-7xl gap-10 px-6 py-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        <div className="py-8">
          {business.logoUrl && <SafeImage src={business.logoUrl} fallback={defaultProductImage} alt={`${business.name} logo`} className="mb-6 h-16 w-16 rounded-full object-cover" />}
        ...
        <SafeImage src={heroImage} fallback={defaultProductImage} alt={business.name} className="aspect-[4/3] w-full object-cover" />
      </section>
